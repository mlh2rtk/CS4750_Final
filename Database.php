...
class Database {
    ...
    public function make_tables(){
        ...
        /// Repeated 3
        $res = $this->dbConnector->query(  "CREATE TABLE IF NOT EXISTS `Shop_Owner` (shop_username VARCHAR(50) NOT NULL, location_id INT, password VARCHAR(50) NOT NULL, PRIMARY KEY(shop_username), FOREIGN KEY (location_id) REFERENCES Location(location_id));");
