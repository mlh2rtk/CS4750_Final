...
class Database {
    ...
    public function make_tables(){
        ...
        $res = $this->dbConnector->query(  'CREATE TABLE IF NOT EXISTS `Customer`(first_name VARCHAR(50) NOT NULL, last_name VARCHAR(50) NOT NULL, username VARCHAR(50) NOT NULL, pass VARCHAR(50) NOT NULL, email VARCHAR(50) NOT NULL, phone VARCHAR(10), PRIMARY KEY(username));');
        ...
        /// Repeated 3
        $res = $this->dbConnector->query(  "CREATE TABLE IF NOT EXISTS `Shop_Owner` (shop_username VARCHAR(50) NOT NULL, location_id INT, password VARCHAR(250) NOT NULL, PRIMARY KEY(shop_username), FOREIGN KEY (location_id) REFERENCES Location(location_id));");
